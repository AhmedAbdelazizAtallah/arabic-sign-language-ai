...
st.markdown(
    ...
    <div class="hero">
      <div>
        ...
        <p>YOLOv8 · بناء تلقائي للكلمات والجمل · نطق وترجمة فورية</p>
      </div>
      <div>
...
تطبيق ذكي يستخدم **YOLOv8** لاكتشاف حروف لغة الإشارة العربية في الوقت الفعلي،
...
**التقنيات:** YOLOv8 · Streamlit · OpenCV · gTTS · deep-translator
""")
